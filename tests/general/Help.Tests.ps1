...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSEncrypt\functions", "$global:testroot\..\PSEncrypt\internal\functions"),
	
	[string]
	$ModuleName = "PSEncrypt",
...
$CommandPath = @(
    "$global:testroot\..\PSEncrypt\functions"
    "$global:testroot\..\PSEncrypt\internal\functions"
)
