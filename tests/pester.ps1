...
Remove-Module PSEncrypt -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSEncrypt\PSEncrypt.psd1"
Import-Module "$PSScriptRoot\..\PSEncrypt\PSEncrypt.psm1" -Force
